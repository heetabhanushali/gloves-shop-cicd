...
Use this helm chart to customise your install of Gloves Shop.

### Helm v2.x

```shell
$ helm install --name gloves-shop --namespace gloves-shop .
```

### Helm v3.x

```bash
$ kubectl create ns gloves-shop
$ helm install gloves-shop --namespace gloves-shop .
```
...
```shell
$ helm install gloves-shop --set openshift=true helm
```
